...
public class Principal extends JFrame implements ActionListener{
	...
	public Principal() {
		...
		nombreAdministrador = ventanaBienvenida.texto; //Tengo que indicar el objeto que cree para guardar la variable. 
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == miElCreador) {
			JOptionPane.showMessageDialog(null, "Desarrollado por Jorge Chaparro. \n" +
										"\n    Basado en el curso de Programación de Java.");
		}
	}
